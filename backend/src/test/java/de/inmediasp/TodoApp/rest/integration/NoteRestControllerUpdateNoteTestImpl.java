...
class NoteRestControllerUpdateNoteTestImpl {
    ...
    void updateNote() throws Exception {
        ...
        NewNoteRequest newNoteRequest = NewNoteRequest.builder().title("valid Title").content("{\"task\": \"valid tasks\", \"status\": false}").correspondent(testUsername4).build();
        ...
        testResponse
                ...
                .andExpect(jsonPath("$.correspondent").value(testUsername4));
